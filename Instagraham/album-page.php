...
<body>
    ...
    $q = 'SELECT * FROM album INNER JOIN photo ON album.idalbum = photo.idalbum';
    // set the pointer to the first result. If there are no results, tell the user.
    if ($res = $mysqli->query($q)) {
        if ($res->data_seek(0)) {
            while ($row = $res->fetch_assoc()) {    // fetch the associative array for the next row
                ...
                echo '<div class="column top" style="font-size:9pt; padding-top:15px">';
                echo "<p><b>" . $row['title'] . "</b></p>";
                echo "<p><b>" . $row['imageurl'] . "</b></p>";
                ...
                echo "<a href=\"remove-photo.php?id=" . $row['idphoto'] . "\">Remove From Album</a>";
                echo '</div>';
                echo '</div>';
                echo '</span>';
                echo '</div>';
                ...
                echo '</script>';
                        ...
                        echo '<div class="column bottom">';
                            echo "<b>Photo ID : &ensp; </b>" . $row['idphoto'] . "<br>\n";
                        echo '</div>';
                        echo "<br><br><br><br>";
