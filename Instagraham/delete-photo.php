...
<html lang="en">
	...
	<body>
    	...
    	<div style= "margin-left:260px; margin-top:150px">
            ...
            if ($mysqli->query($q)) {
                echo '<p>Photo ' . $_GET['id'] . ' deleted.</p>'; //result 
            }
            else {
    	...
    	<!-- Go to back button -->
        <div style= "margin-left:230px; margin-top:20px; cursor:pointer" onclick="goBack()" class="back-btn">&#x0003C; &ensp; Back to Instagraham</div>
	...
	<!-- Footer -->
	 <footer>
        <div class="footer">
    			<p><b>Copyright &copy; 2021 Instagraham Inc.</b><br>
    			Best viewed on Chrome browsers.</p>
    	</div>
	</footer>
